...
<template>
  <div class="w-full mt-6 lg:mt-4 xl:mt-2 flex flex-col text-lg">
    <div class="flex justify-evenly items-end md:space-x-20 lg:space-x-32">
      <p class="ml-2 lg:ml-1">Favorites</p>
